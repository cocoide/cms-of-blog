...
const SelectTarget = () => {
  ...
  return (
    <div className="top-16 w-2/5 bg-transparent">
      <Combobox value={selected} onChange={setSelected}>
        <div className="relative mt-1">
          <div className="w-full cursor-default overflow-hidden text-ce focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-indigo-300 sm:text-sm">
            <Combobox.Input
                  ...
                  <Combobox.Option
                    ...
                    className={({ active }) =>
                      `relative cursor-default select-none py-2 pl-10 pr-4 ${
                        active ? 'bg-indigo-300 text-white' : 'text-indigo-300'
                      }`
                    }
                    value={person}
                  >
